...
"""
images_all = r"C:\project_pid\pythonProject\.venv\dataset\images\all"
labels_all = r"C:\project_pid\pythonProject\.venv\dataset\labels\all"

base_dir = r"C:\project_pid\pythonProject\.venv\dataset"
...
image_files = [f for f in os.listdir(images_all) if f.lower().endswith((".png"))]
image_files.sort()
